# Django settings for yt_tut project.
import os
...
SECRET_KEY = '7f7iyw95b@yt0!xl@n&876@7pu1@=5t#j8p8jlorhzj(1vj0t8'
...
ROOT_URLCONF = 'yt_tut.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'yt_tut.wsgi.application'
